...
var ChatService = _interopRequireWildcard(require("../services/chat.service"));
...
var addConversation = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return ChatService.addConversation(req.body);
  ...
  return function addConversation(_x, _x2, _x3) {
...
var getMyConversation = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _context2.next = 3;
            return ChatService.getMyConversation(req.body);
  ...
  return function getMyConversation(_x4, _x5, _x6) {
...
var getMyMessages = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.prev = 0;
            _context3.next = 3;
            return ChatService.getMyMessages(req.body);
  ...
  return function getMyMessages(_x7, _x8, _x9) {
...
var getParticularConversationId = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            _context4.prev = 0;
            _context4.next = 3;
            return ChatService.getParticularConversationId(req.body);
  ...
  return function getParticularConversationId(_x10, _x11, _x12) {
